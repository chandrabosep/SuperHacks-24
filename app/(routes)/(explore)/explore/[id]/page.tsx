			...
			<div className="container mx-auto max-w-5xl">
				...
				<div className="">
					<p className="text-muted-foreground">
						Acme Web Application is a comprehensive platform that
						provides a wide range of features to help users
						streamline their workflow. With a focus on user-friendly
						design and cutting-edge functionality, the application
						offers a seamless experience for managing tasks,
						collaborating with team members, and accessing valuable
						insights.
					</p>
				</div>
